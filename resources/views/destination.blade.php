...
<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <a href="{{ route('entries.index', ['destination' => $destination]) }}" id="clickableSection" class="block bg-white shadow-md rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
            <section>
